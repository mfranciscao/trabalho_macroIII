...
$\displaystyle P_{i,t} \equiv \left( \int_0^1 P_{i,t}(j)^{1-\varepsilon}dj \right)^{\frac{1}{1-\varepsilon}}$ and
...
## 3 - Finding the optimal share between the domestic and imported goods
...
($D_{t+1}$): $\displaystyle \beta^t \lambda_t \mathbb{E} [Q_{t,t+1}] = \beta^{t+1} \mathbb {E}[\lambda_{t+1}]  \ \ \Rightarrow \ \ \frac{\mathbb{E}[\lambda_{t+1}]}{\lambda_t} = \frac{\mathbb{E} [Q_{t,t+1}]}{\beta}$
...
as $\mathbb{E}[Q_{t,t+1}]$, is the price of a a riskless one-period discount bond in domestic currency with gross return $R_t$.
